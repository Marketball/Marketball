  ...
  >
    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
      ...
      <div style={{ textAlign: "center", padding: "0 12px", flexShrink: 0 }}>
        {(isLive || isFinished)
          ? <div ref={scoreRef} style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 34, color: "#f1f5f9", letterSpacing: 3, lineHeight: 1, textShadow: isLive ? "0 0 20px rgba(239,68,68,0.35)" : "none" }}>
